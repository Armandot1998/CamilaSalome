...
<!-- Page Title -->
<title>Fundación Camila Salome - Nosotros</title>
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="imagenes/fondo.jpg">
      <div class="container pt-100 pb-50">
        ...
        <div class="section-content pt-100">
          <div class="row"> 
            <div class="col-md-12">
              <h3 class="title text-white">NOSOTROS</h3>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="section-content">
          <div class="row mt-30 mb-20 pt-10 pb-20 pl-10 pr-10">
            <div class="col-md-6">
              <p align="center"><strong>Nuestra misión:</strong></p>
<p align="justify">Brindar educación domiciliaria a niños, niñas y adolescentes con cáncer y otras enfermedades catastróficas, mediante la asistencia de docentes domiciliarias, que les permita continuar con sus estudios y mejorar su calidad de vida.</p>
              <br><p align="center"><strong>Nuestra visión:</strong></p>
<p align="justify">Ser un referente nacional e internacional en educación domiciliaria de niños, niñas y adolescentes con cáncer y otras enfermedades catastróficas.</p>
            </div>
            <div class="col-md-6">
            <p align="center"><strong>Nuestros Valores:</strong>
