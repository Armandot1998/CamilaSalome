            ...
            <div class="blog-posts single-post">
              <article class="post clearfix mb-0">
                ...
                <div class="entry-content">
                  ...
                  <!-- EN ESTA PARTE VA UN PARRAFO IMPORTANTE O A RESALTAR DE LA NOTICIA, SI NO SE REQUIERE ELIMINAR TODA ESTA PARTE -->
                  <blockquote class="theme-colored pt-20 pb-20">
                    <p align="justify">Para Barbery, a través del intercambio de abrazos, “logramos brindar seguridad, reforzar la autoestima, alegrar el espíritu, reconocer nuestros propios límites, fusionar cuerpo, mente y emociones, celebrar la vida, conectar con el aquí y ahora y aliviar la soledad”.</p>
                  </blockquote>
                   <!-- EDITAR HASTA AQUÍ O BORRAR HASTA AQUÍ SI NO ES NECESARIO-->
