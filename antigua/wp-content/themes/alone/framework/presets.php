...
function bearstheme_autoCompileLess($inputFile, $outputFile) {
	...
	$main_color = (isset($bearstheme_options['main_color'])&&$bearstheme_options['main_color'])?$bearstheme_options['main_color']: '#C42781';
...
function bearstheme_addLessStyle() {
	...
	try {
		...
		$outputFile = ABS_PATH.'/assets/css/presets/'.$preset_color.'.css?ver=4.6.3';
