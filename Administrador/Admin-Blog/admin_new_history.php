                    ...
                    <div class="col-md-8">
                        <div class="panel-body">
                            <form role="form" action="./process/new_blog.php" method="post" enctype="multipart/form-data" id="frm_Blog">
                                ...
                                <input style="display:none" value="HV" type="text" class="form-control" id="type_blog" name="type_blog" />
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <a href="../Historias-De-Vida.php" id="navbarDropdownMenuLink" class="btn btn-default">Cancelar</a>
                                                        </div>
                                                        <div class="col-md-6">
