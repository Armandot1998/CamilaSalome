<?php
  ...
  $blogs_x_pagina = 6;
  if(!$_GET){
    header('Location:./Historias-De-Vida.php?pagina=1');
  };
  $rows = 0;
        ...
        <?php import_meta($long_path); ?>
            ...
            <script>
                $(document).ready(function() {
                    var x = document.getElementById("NvarHDV");
                    x.className = "active";
                });
            </script>
      ...
      ?>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <a href="./Admin-Blog/admin_new_history.php" id="navbarDropdownMenuLink" class="btn btn-primary btn-lg  mt-20">CREAR NUEVO BLOG</a>
                    </div>
                    <div class="col-md-5">
                    </div>
                </div>
                                        ...
                                        <article class="post clearfix mb-sm-30 border-bottom-theme-color-2px bg-silver-light">
                                            <div class="entry-header">
                                                <div class="post-thumb thumb">
                                                    ...
                                                    <div class="box">
                                                        <img class="card-img-top " src="<?php echo  $long_path ?>imagenes/Blog-Img/<?php echo  $results['name'] ?>" alt="Image did not load...">
                                                    </div>
                ...
                <nav aria-lave="Pagina de ejemplo">
                    <ul class="pagination">
                        <li class="page-item  <?php echo $_GET['pagina'] >=1 ? 'disabled' : '' ?> ">
                            <a class="page-link" href="./Historias-De-Vida.php?pagina=<?php echo ($_GET['pagina'])-1 ?>">Anterior</a></li>
                        <?php for($i=0;$i<$paginas;$i++): ?>
                            <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active' : '' ?>  ">
                                <a class="page-link" href="./Historias-De-Vida.php?pagina=<?php echo $i+1 ?>">
                                    <?php echo $i+1 ?>
                                </a>
                            </li>
                            <?php endfor ?>
                                ...
                                <li class="page-item <?php echo $_GET['pagina'] >= $paginas ? 'disabled' : '' ?> ">
                                    <a class="page-link" href="./Historias-De-Vida.php?pagina=<?php echo ($_GET['pagina'])+1 ?>">Siguiente</a>
                                </li>
                    </ul>
                </nav>
            </div>
