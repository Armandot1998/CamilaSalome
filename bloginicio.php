                    ...
                    <article class="post clearfix mb-sm-30 border-bottom-theme-color-2px bg-silver-light">
                        <div class="entry-header">
                            <div class="post-thumb thumb">
                                ...
                                <img src="imagenes/blog/abrazo.jpg" alt="" class="img-responsive img-fullwidth">
                                <!-- EDITAR HASTA AQUÍ -->
                        ...
                        <div class="entry-content p-20 pr-10">
                            <div class="entry-meta media mt-0 no-bg no-border">
                                <div class="entry-date media-left text-center flip bg-theme-colored pt-5 pr-15 pb-5 pl-15">
                                    <ul>
                                        ...
                                        <li class="font-16 text-white font-weight-600 border-bottom">9</li>
                                        <li class="font-12 text-white text-uppercase">Abr</li>
                                        <!-- EDITAR HASTA AQUÍ -->
                            ...
                            <a href="noticia.php" class="btn btn-default btn-sm btn-theme-colored mt-10">Leer más</a>
                            <!-- EDITAR HASTA AQUÍ -->
                    ...
                    <article class="post clearfix mb-sm-30 border-bottom-theme-color-2px bg-silver-light">
                        <div class="entry-header">
                            <div class="post-thumb thumb">
                                ...
                                <!-- EN ESTA PARTE VA LA IMAGEN DE LA NOTICIA -->
                                <img src="imagenes/blog/maestras.jpg" alt="" class="img-responsive img-fullwidth">
                                <!-- EDITAR HASTA AQUÍ -->
                    ...
                    <article class="post clearfix mb-sm-30 border-bottom-theme-color-2px bg-silver-light">
                        <div class="entry-header">
                            <div class="post-thumb thumb">
                                ...
                                <!-- EN ESTA PARTE VA LA IMAGEN DE LA NOTICIA -->
                                <img src="imagenes/blog/visita.jpg" alt="" class="img-responsive img-fullwidth">
                                <!-- EDITAR HASTA AQUÍ -->
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
            <article class="post clearfix mb-sm-30 border-bottom-theme-color-2px bg-silver-light">
                ...
                <div class="entry-content p-20 pr-10">
                    <div class="entry-meta media mt-0 no-bg no-border">
                        <div class="entry-date media-left text-center flip bg-theme-colored pt-5 pr-15 pb-5 pl-15">
                            <ul>
                                ...
                                <!-- EN ESTA PARTE VA LA FECHA DE LA NOTICIA -->
                                <li class="font-16 text-white font-weight-600 border-bottom">4</li>
                    ...
                    <!-- EN ESTA PARTE VA UN PARRAFO DE LA NOTICIA -->
                    <p class="mb-15" align="justify">Es la una de la tarde y Estefy, de siete años, llega de la mano de Luz, su madre, a casa para empezar la clase del día. Viene sonriendo al indicarnos sus botas nuevas. A sus siete años, el cabello de Estefy es bastante corto comparado con el de su hermana, debido a la quimioterapia que le ayuda a combatir la leucemia que le diagnosticaron hace aproximadamente dos años.</p>
                    <!-- EDITAR HASTA AQUÍ -->

                    <!-- EN ESTA PARTE VA EL ENLACE HACIA LA NOTICIA -->
                    <a href="noticia2.php" class="btn btn-default btn-sm btn-theme-colored mt-10">Leer más</a>
                    <!-- EDITAR HASTA AQUÍ -->
