...
?>
    ...
    <head>
        ...
        <title>Fundación Camila Salomé - Historias de vida</title>
        <script>
            (function(d, s, id) {
       ...
       $blogs_x_pagina = 6;
       if(!$_GET){
         header('Location:./historia-de-vida.php?pagina=1');
       };
       $rows = 0;
                ...
                <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="imagenes/blog.jpg">
                    <div class="container pt-100 pb-50">
                        <div class="section-content pt-100">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 class="title text-white">Historias de Vida</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <nav aria-lave="Pagina de ejemplo">
                        <ul class="pagination">
                            <li class="page-item  <?php echo $_GET['pagina'] >=1 ? 'disabled' : '' ?> ">
                                <a class="page-link" href="historia-de-vida.php?pagina=<?php echo ($_GET['pagina'])-1 ?>">Anterior</a></li>
                            <?php for($i=0;$i<$paginas;$i++): ?>
                                <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active' : '' ?>  ">
                                    <a class="page-link" href="historia-de-vida.php?pagina=<?php echo $i+1 ?>">
                                        <?php echo $i+1 ?>
                                    </a>
                                </li>
                                <?php endfor ?>
                                    ...
                                    <li class="page-item <?php echo $_GET['pagina'] >= $paginas ? 'disabled' : '' ?> ">
                                        <a class="page-link" href="historia-de-vida.php?pagina=<?php echo ($_GET['pagina'])+1 ?>">Siguiente</a>
                                    </li>
                        </ul>
                    </nav>
            </div>
