...
<!-- Page Title -->
<title>Fundación Camila Salome - Apoyo Socioemocional</title>
...
<div id="wrapper" class="clearfix">
  ...
  <div class="main-content">
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="imagenes/apoyobanner.jpg">
      <div class="container pt-100 pb-50">
        <!-- Section Content -->
        <div class="section-content pt-100">
          <div class="row"> 
            <div class="col-md-12">
              <h3 class="title text-white">Programas de Apoyo</h3>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-7 mb-sm-40">
              <h2 class="text-uppercase font-weight-600 mt-0 font-28 line-bottom" style="font-family: 'Playfair Display', serif">APOYO SOCIOEMOCIONAL PARA PACIENTES ESTUDIANTES Y SUS FAMILIAS.</h2>
              <p align="justify">A través de un profesional en psicología clínica, se genera espacios para contención emocional por medio de la escucha activa que le permita al estudiante enfermo hablar abiertamente de lo que sucede y que conozca las acciones que se realizarán para mejorar su condición; así como espacios colectivos de abordaje y contención psico- afectiva de la problemática.</p>
            </div>
            <div class="col-md-5">
