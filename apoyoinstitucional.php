...
<!-- Page Title -->
<title>Fundación Camila Salome - Amigos de Camila</title>
...
<div id="wrapper" class="clearfix">
  ...
  <div class="main-content">
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="imagenes/apoyo2.jpg">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-7 mb-sm-40">
              <h2 class="text-uppercase font-weight-600 mt-0 font-28 line-bottom" style="font-family: 'Playfair Display', serif">SENSIBILIZACIÓN “AMIGOS DE CAMILA”</h2>
              <p align="justify">A través de este proyecto pretendemos generar un compromiso y participación activa de las Instituciones Educativas, Empresas Privadas y Sociedad en general en la defensa del derecho de los niños, niñas y adolescentes con cáncer a recibir educación para alcanzar una mejor calidad de vida.</p>
            </div>
            <div class="col-md-5">
